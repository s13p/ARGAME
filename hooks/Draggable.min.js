...
! function(e, t) {
    ...
    function Va(e) {
        var t;
        return !(!e || !e.getAttribute || e === l) && (!("true" !== (t = e.getAttribute("data-clickable")) && ("false" === t || !e.onclick && !o.test(e.nodeName + "") && "true" !== e.getAttribute("contentEditable"))) || Va(e.parentNode))
    }
    ...
    function Draggable(h, p) {
        ...
        return (t = Draggable.get(h)) && t.kill(), e.startDrag = function(e, t) {
            ...
            return Ia(h, Oh), u = !1, Se && "soft" !== e && Se.untrack(f || h, Q ? "x,y" : W ? "rotation" : "top,left"), f && f.disable(), xa(yh), q.isDragging = q.isPressed = y = !1, n && Qa(q, "dragend", "onDragEnd"), q
        ...
        isDragging: !1,
        isPressed: !1
    }), F.zIndex = 1e3, F.version = "3.11.5", Y() && xe.registerPlugin(F), e.Draggable = F, e.default = F;
